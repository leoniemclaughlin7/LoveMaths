...
function runGame(gameType) {
    ...
    if (gameType === 'addition') {
        ...
        displayDivisionQuestion(num1D, num2);
    } else {
        alert(`Unknowing game type: ${gameType}`);
        throw `Unknowing game type: ${gameType}. Aborting!`;
    }
}
...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`awwww... you answered ${userAnswer}. The correct answer was ${caculatedAnswer[0]}!`);
